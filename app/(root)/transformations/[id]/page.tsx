      ...
      <section className="mt-10 border-t border-dark-400/15">
        <div className="transformation-grid">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Image width={getImageSize(image.transformationType, image, "width")} height={getImageSize(image.transformationType, image, "height")} src={image.secureUrl} alt="image" className="transformation-original_image" />
          </div>
